...
data_all <- list.files(path = "C:/Users/lbouillo/Documents/PAUL/Meudon/N500/",  # Identify all CSV files
...
data$DateTime <- sub(pattern = "1/", replacement = "01/", data$DateTime)
data$DateTime <- sub(pattern = "2/", replacement = "02/", data$DateTime)
data$DateTime <- sub(pattern = "3/", replacement = "03/", data$DateTime)

data$DateTime <- sub(pattern = "101/", replacement = "11/", data$DateTime)
data$DateTime <- sub(pattern = "102/", replacement = "12/", data$DateTime)
data$DateTime <- sub(pattern = "103/", replacement = "13/", data$DateTime)
data$DateTime <- sub(pattern = "201/", replacement = "21/", data$DateTime)
data$DateTime <- sub(pattern = "202/", replacement = "22/", data$DateTime)
data$DateTime <- sub(pattern = "203/", replacement = "23/", data$DateTime)
data$DateTime <- sub(pattern = "301/", replacement = "31/", data$DateTime)



data$DateTime <- sub(pattern = "4/", replacement = "04/", data$DateTime)
data$DateTime <- sub(pattern = "5/", replacement = "05/", data$DateTime)
data$DateTime <- sub(pattern = "6/", replacement = "06/", data$DateTime)
data$DateTime <- sub(pattern = "7/", replacement = "07/", data$DateTime)
data$DateTime <- sub(pattern = "8/", replacement = "08/", data$DateTime)
data$DateTime <- sub(pattern = "9/", replacement = "09/", data$DateTime)

data$DateTime <- as.POSIXct(data$DateTime, format = '%m/%d/%Y %I:%M:%S %p', tz="UTC")
...
write.table(data,"C:/Users/lbouillo/Documents/PAUL/Meudon/N500/NOx_01-03.csv", sep=",", row.names = FALSE)
plot_NO <- ggplot()+
